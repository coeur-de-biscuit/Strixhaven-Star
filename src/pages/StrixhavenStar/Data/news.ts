...
Professora Nassari
  ...
  {
    id: 2,
    image: 'https://th.bing.com/th/id/OIG.Dcb6smYOgyqQvXwmtEUi?pid=ImgGn&w=1024&h=1024&rs=1',
    title: 'Nova aluna chega a escola com uma semana de atraso.',
    badgeTitle: 'Fofoca',
    badgeColor: '#f55d42',
    ...
    Nerina, uma ninfa de beleza transcendental, foi avistada pelos corredores da escola, deixando um rastro de curiosidade em seu caminho. Rumores sobre sua origem se espalharam rapidamente, e a intrépida Mina Lee, conhecida por sua habilidade em desvendar segredos, revelou que a nova aluna vem da deslumbrante região de Prismeer, situada no Faywild.
    
    Prismeer é conhecida por seus bosques élficos exuberantes e paisagens mágicas, e a origem da ninfa só aumenta o fascínio em torno de sua entrada tardia em Strixhaven. A mãe de Nerina, Zybilna, acrescenta um elemento adicional de mistério à narrativa, deixando os estudantes ansiosos por descobrir mais sobre a conexão entre mãe e filha.
  ...
  {
    id: 3,
    image: 'https://5e.tools/img/book/SCC/062-03-034.webp',
    title: 'Strixhaven contrata nova responsável para a segurança do colégio.',
    badgeTitle: 'Notícia ',
    badgeColor: '#0388fc',
    readingTime: '6 minutos',
    tipo: 2,
    ...
    Localizada em um plano de existência complexo e interdimensional, Sigil é conhecida por suas portas que se conectam a diversos planos e dimensões. No entanto, a cidade é famosa não apenas por suas oportunidades únicas, mas também por seus perigos imprevisíveis.
    
    Os estudantes, movidos pela curiosidade e talvez uma busca por emoções além dos limites dos corredores acadêmicos, têm sido avistados em diferentes distritos de Sigil, muitas vezes enfrentando criaturas mágicas e desafios inesperados. Autoridades de Strixhaven expressaram profunda preocupação com a segurança dos alunos, lembrando que a cidade possui muitos segredos sombrios e é imperativo que os estudantes permaneçam dentro dos limites seguros da escola.
    
    Diante dessas escapadas regulares, a administração de Strixhaven tomou medidas significativas para garantir a segurança de seus alunos. A renomada Capitã Dapplewing, uma experiente aventureira e especialista em planos interdimensionais, foi contratada para comandar a segurança do colégio.
    
    A Capitã Dapplewing é conhecida por sua habilidade estratégica e destemor em face de perigos desconhecidos. Sua nomeação visa reforçar a segurança nas fronteiras da escola e desencorajar os estudantes a se aventurarem em áreas desconhecidas e potencialmente perigosas.
    
    Em uma declaração oficial, a Capitã Dapplewing expressou seu compromisso em garantir a segurança dos alunos de Strixhaven. "A magia é uma ferramenta poderosa, mas também exige responsabilidade. Estou aqui para garantir que os estudantes possam se concentrar em seus estudos, sem se colocarem em risco desnecessário ao explorar os perigos de Sigil."
  ...
  {
    id: 4,
    image: 'https://th.bing.com/th/id/OIG.L8dE6Z90KbLZDq8zSBNK?pid=ImgGn&w=1024&h=1024&rs=1',
    title: 'Duelos Espetaculares no Clube de Duelos de Strixhaven: Vitória de Wanda Nontao e Surpresa na Competição em Duplas',
    badgeTitle: 'Notícia',
    badgeColor: '#0388fc',
    readingTime: '2 minutos',
    tipo: 2,
    writter: 'Grayson Wildemere',
    content: `O primeiro dia do tão aguardado Clube de Duelos de Strixhaven foi marcado por batalhas intensas e surpreendentes, deixando os espectadores empolgados e ansiosos por mais emoções mágicas. A competição, que reuniu alguns dos talentos mais promissores da escola, teve como destaque a notável Wanda Nontao, que não só brilhou na competição solo, mas também se destacou nas disputas em duplas.

    Na competição de duelos solo, Wanda Nontao surpreendeu a todos ao vencer de maneira impressionante, derrotando adversários formidáveis como Amélia Moonflower e Aires Oriande. Sua habilidade magistral e estratégias astutas foram o centro das atenções, consolidando sua reputação como uma das duelistas de Strixhaven.
    
    Entretanto, a surpresa da noite veio na competição em duplas. Na final acirrada, Aires Oriande e Serana Cortinarius mostraram uma incrível sincronia, derrotando Wanda Nontao e sua irmã Katherine em um duelo emocionante. A vitória de Oriande e Cortinarius trouxe uma reviravolta inesperada, demonstrando a imprevisibilidade e o talento diversificado presente no Clube de Duelos.
    
    Os duelos foram acompanhados por uma plateia entusiasmada de colegas estudantes, professores e entusiastas da magia, todos testemunhando o surgimento de novos líderes no mundo dos duelos mágicos. A energia vibrante e as estratégias únicas dos participantes tornaram o evento um sucesso retumbante.
  ...
  {
    id: 5,
    image: 'https://images.ctfassets.net/swt2dsco9mfe/2dgUO1oyXglpSEAcmqN6oh/c3dfa22003efeb00bbdf1843194e5ad4/iwbciuwbjwdb.jpg?q=70&w=1920',
    title: 'Magia em União: Os Inúmeros Benefícios dos Alunos de Strixhaven em Clubes Mágicos.',
    badgeTitle: 'Publieditorial ',
    badgeColor: '#f5d442',
    readingTime: '4 minutos',
    tipo: 2,
    writter: 'Strixhaven Staff',
    content: ` Em Strixhaven, onde a magia é mais do que um conjunto de habilidades, mas uma experiência de vida, os alunos têm uma oportunidade única de aprimorar suas habilidades mágicas e ampliar seus horizontes ao se juntarem a clubes. Estes, longe de serem apenas sociedades de estudo, são espaços de camaradagem, crescimento pessoal e descobertas mágicas inesquecíveis.

    1. Desenvolvimento de Habilidades Específicas:
    
    Cada faculdade em Strixhaven abriga uma variedade de clubes, desde clubes de duelos até clubes específicos de faculdade, oferecendo aos alunos a chance de aprimorar suas habilidades mágicas em um ambiente mais especializado. Se você é um aluno de Silverquill interessado em magia de comunicação, há clubes focados em feitiços e encantamentos eloquentes.
    
    2. Exploração de Interesses Únicos:
    
    Os clubes não se limitam apenas às disciplinas acadêmicas. Alunos podem explorar seus interesses mágicos únicos ao ingressar em clubes dedicados a áreas como adivinhação, criação de poções, ou até mesmo exploração de planos interdimensionais. Esses clubes proporcionam um ambiente descontraído para a experimentação e o aprofundamento de conhecimentos.
    
    3. Companheirismo Mágico:
    
    Os clubes são uma oportunidade para os alunos de Strixhaven formarem laços duradouros e construírem amizades baseadas em interesses compartilhados. O ambiente informal dos clubes permite que os estudantes troquem experiências, aprendam uns com os outros e criem memórias mágicas juntos.
    
    4. Preparação para Duelos e Competições:
    
    Para aqueles que buscam aprimorar suas habilidades em duelos mágicos, muitos clubes oferecem treinamento especializado. A prática constante e a troca de estratégias proporcionam aos alunos uma vantagem competitiva em eventos como o Clube de Duelos de Strixhaven, criando uma atmosfera emocionante e enriquecedora.
    
    5. Desenvolvimento Pessoal e Liderança:
