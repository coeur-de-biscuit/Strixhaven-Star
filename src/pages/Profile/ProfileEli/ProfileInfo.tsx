    ...
    <View style={{ marginBottom: 20 }}>
      ...
      <View style={{ alignItems: 'center' }}>
        <View style={{ width: 100, height: 100, borderRadius: 50 }}>
          <Image
            source={{ uri: 'https://th.bing.com/th/id/OIG3.TLmM..IrJ3kbxC820w2w?pid=ImgGn' }}
            style={{ flex: 1, width: undefined, height: undefined, borderRadius: 50 }}
          />
        </View>
        <View>
          <Text style={{ fontWeight: 'bold', fontSize: 28, color: 'black' }}>Elliot Moonflower</Text>
